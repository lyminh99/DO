...
screen databaseEle:
    ...
    if persistent.Sys_Langue == "ENG":
        textbutton "Return" action Hide ('databaseEle'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 style "Style_MainMenu"  at Sys_Eff_Appear
    elif persistent.Sys_Langue == "VN":
        textbutton "Trở lại" action Hide ('databaseEle'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 style "Style_MainMenu" at Sys_Eff_Appear
...
screen databaseAzu:
    ...
    if persistent.Sys_Langue == "ENG":
        textbutton "Return" action Hide ('databaseAzu'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 style "Style_MainMenu" at Sys_Eff_Appear
    elif persistent.Sys_Langue == "VN":
        textbutton "Trở lại" action Hide ('databaseAzu'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 style "Style_MainMenu" at Sys_Eff_Appear
