...
\n 
    "
    nvlDC"\n {i}“Nếu cậu đọc được những dòng chữ này, không cần biết cậu đang ở đâu, có nghĩa là cậu đã đồng ý làm theo lời ta.”"
    nvlDC"\n “Thực chất kế hoạch của ta rất đơn giản: Ba ngày trước khi diễn ra cái gọi là Lễ hội Mặt trời – ngày 3/6, tất cả các thành viên Aurora sẽ tập trung lại, bàn cách đối phó. Đây là cơ hội duy nhất để cậu có thể can thiệp.”"
    nvlDC"\n “Nếu cậu muốn giải cứu Azzurra, cậu chỉ cần bước vào nhà của hai người đồng sự của ta, và – nếu thị giác của cậu vẫn còn tốt – bước ra cùng với cô bé trong vòng năm phút đồng hồ. Chiếc chìa khóa này mở được tất cả mọi cửa nẻo trong ngôi nhà nhỏ của nhóm Schellendorf.”"
    nvlDC"\n “Đó là thứ cậu cần. Thế còn cái ta cần lại là một thứ khác, và ta hy vọng cậu sẽ giúp ta tìm ra thứ đó nếu cậu thấy tiện.”"
    nvlDC"\n “Trong ngôi nhà cậu sẽ tìm thấy một cái két sắt. Bên trong đó là những tài liệu nghiên cứu của nhóm Schallendorf về bản chất của thế giới chúng ta đang sống. Ngoài ra, ta dám chắc nếu họ có liên hệ với Giáo hội để thỏa thuận việc Azzurra, cậu sẽ tìm thấy thư từ liên quan trong đó.”"
    nvlDC"\n “Ta cần cậu kiếm giúp ta cả hai thứ đó và mang cho ta trước khi họ nhận ra ta đứng sau việc này. Lần cuối cùng ta kiểm tra, mã số mở két là N1B31-1-1NG-3N1-13D. ”"
    nvlDC"\n “Dĩ nhiên, lựa chọn là của cậu – nhưng ta dám bảo đảm bằng danh dự của một nhà khoa học rằng cậu sẽ không chịu thiệt nếu cậu giúp ta việc này.”"
    nvlDC"\n “Nếu cậu nhận lời, hãy coi như ba đồng tiền vàng này là tiền đặt cọc kèm lộ phí. Nếu không, hãy coi đó là món quà của một nhà khoa học rảnh rỗi có chút tiền tiêu vặt trong tay.”"
    nvlDC"\n “Chúng ta sẽ liên lạc sau khi cậu mang được Azzurra về nhà an toàn. Cho tới lúc đó, chúc cậu may mắn, luôn tỉnh táo và suy nghĩ lý tính.”    {/i}
\n 
    "
...
\n 
    "
    nvlDC"\n {i}Tay tôi lần lần mặt bản đồ: Từng chi tiết, từng con đường, từng nhánh sông suối, từng ngọn đồi, từng khoảnh rừng đều được vẽ nên và chú thích cẩn thận. Cứ như là Aurora đang tuyên bố với phần còn lại của thế giới, “Đây là lãnh thổ của chúng ta”."
    nvlDC"\n Tôi suýt nữa bỏ qua một dấu gạch chéo trên vùng đất chưa quá ranh giới kiểm soát của giáo hội, có ghi chú đàng hoàng “Schallendorf”."
    nvlDC"\n Tôi bất giác rùng mình. Dường như họ đã thoát khỏi cái xác là một hội kín từ lúc nào không biết, và bây giờ đang trỗi dậy, trở thành một thế lực sẵn sàng thách thức trật tự thế giới."
    nvlDC"\n Liệu tôi có muốn bị cuốn vào vòng xoáy ấy không? Không, nếu tham gia vào vụ việc này, dù muốn dù không, tôi có bị cuốn vào vòng xoáy ấy không?
    {/i}
    "
    nvl clear
...
#Thời gian: Sáng
    ...
    "
    nvlDC"
\n Vâng, Anatolio Pietro, ngươi đã bị bắt. Elena rảo bước lại gần phía tôi và nhún mình một cách không-thể-lịch-thiệp-hơn.
    "
    nvl clear
