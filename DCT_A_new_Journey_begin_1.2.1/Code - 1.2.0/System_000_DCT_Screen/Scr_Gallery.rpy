        ...
        grid gal_rows gal_cols:
            ...
            for gal_item in gallery_cg_items:
                ...
                if i <= (cg_page+1)*gal_cells and i>cg_page*gal_cells:
                    add g_cg.make_button(gal_item + " butt", gal_item + " butt", im.Scale("Images/DCT/Interface/gallocked.png", thumbnail_x, thumbnail_y), xalign=0.5, yalign=0.5, idle_border=None, background=None, bottom_margin=24)  at Sys_Eff_Appear
            for j in range(i, (cg_page+1)*gal_cells): #we need this to fully fill the grid
                null

        if len(gallery_cg_items)>gal_cells:
            if persistent.Sys_Langue == "ENG":
                textbutton _("Next Page") action [SetVariable('cg_page', next_cg_page), ShowMenu("cg_gallery")] yalign 0.96 style "Style_MainMenu" at Sys_Eff_Appear
            elif persistent.Sys_Langue == "VN":
                textbutton _("Trang kế") action [SetVariable('cg_page', next_cg_page), ShowMenu("cg_gallery")] yalign 0.96 style "Style_MainMenu" at Sys_Eff_Appear

    if persistent.Sys_Langue == "ENG":
        textbutton "Return" action Hide ('cg_gallery'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 hovered [ Play ("test_five", "sfx/click.ogg") ]        style "Style_MainMenu" at Sys_Eff_Appear
    elif persistent.Sys_Langue == "VN":
        textbutton "Trở lại" action Hide ('cg_gallery'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 hovered [ Play ("test_five", "sfx/click.ogg") ]        style "Style_MainMenu" at Sys_Eff_Appear
        ...
        grid gal_rows gal_cols:
            ...
            for gal_item in gallery_bg_items:
                ...
                if i <= (bg_page+1)*gal_cells and i>bg_page*gal_cells:
                    add g_bg.make_button(gal_item + " butt", gal_item + " butt", gal_item + " butt dis", xalign=0.5, yalign=0.5, idle_border=None, background=None, bottom_margin=24) at Sys_Eff_Appear
        ...
        frame:
            ...
            vbox:
                if len(gallery_bg_items)>gal_cells:
                    if persistent.Sys_Langue == "ENG":
                        textbutton _("Next Page") action [SetVariable('bg_page', next_bg_page), ShowMenu("bg_gallery")] style "Style_MainMenu" at Sys_Eff_Appear
                    elif persistent.Sys_Langue == "VN":
                        textbutton _("Trang kế") action [SetVariable('bg_page', next_bg_page), ShowMenu("bg_gallery")] style "Style_MainMenu" at Sys_Eff_Appear

    if persistent.Sys_Langue == "ENG":
        textbutton "Return" action Hide ('bg_gallery'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 hovered [ Play ("test_five", "sfx/click.ogg") ]        style "Style_MainMenu" at Sys_Eff_Appear
    elif persistent.Sys_Langue == "VN":
        textbutton "Trở lại" action Hide ('bg_gallery'), Show ('Sys_MainMenu2') xalign 0.98 yalign 0.96 hovered [ Play ("test_five", "sfx/click.ogg") ]        style "Style_MainMenu" at Sys_Eff_Appear