...
#Thời gian: Trưa
    ...
    Az" Will do."
    MS" Giacomo Ivaldi. Michelo Piemonte. Secundo Badoglio. Anatolio Pietro. And..."
    ...
    Az" Father."
    MS" I see. That makes so much sense now."
    show Azu P50 at center
    Az" What is the matter, Father?"
    MS" Never you mind. It's good that you are here with us."

    " I narrow my eyes. Not sure what he means, though that seems... positive at the very least."

    MS" Let us continue. As I said, and Azzurra Ines. Up the platform you go."
    MS" Kneel!"

    " The last adults-to-be, left to right, one after the other, prostrate before the altar."
    "The two bishops wheel to our flanks. One begin walking down our front, the other down our back. "
    "One wields the holy scripture, the other a steel staff. The one places the book upon our forehead, the other pats the staff on our shoulder."
    "I am closer to the one wielding the staff. "
    "The pat of cold iron doesn't hurt as much as I thought, though I still kinda sorta lost my balance just a little – more due to being startled than the actual impact."
...
#Cảnh: Đen
    ...
    " My feet gives way. I collapse on my knee on what appears like the ground. "
    "I'm not sure what is chief within me right now, fear or honor in the audience of the Creator Himself of all beings!"
    ...
    C0" I fear you are seeking an answer that is not meant to be."
    C0"  Yet in your free will and curiosity you will seek it regardless, and come close to it, and will even find one way or another it if you are resourceful enough... which you are."
    ...
    MS" … The Divine shalt watch over your children, protect them for their innocence and punish them for their sin. Now they walk in the sun, as men and women grown, and..."
...
#//NVL
    ...
    "Call it the remaining self-preservation instinct of a child. "
    "Suffice to say a troublemaker suddenly getting an audience with the Creator of all figures? Well, you don't need to be a theologian to know, this is big. Too big."
...
#Thời gian: Sáng
    ...
    hide OngPietro
    show Azu BaPietro at center
    BP" Poor lad. So young and so kind and so good and so promising too! Graced, and about to be a priest at that!"
    ...
    hide OngPietro
    show Azu BaPietro at center
    BP" Poor kid. Shouldn't have raised a stir that day. Caused all sorts of problems, too."

    " The word you probably want, Mom, is “trying to hurt my son”. Though it's perhaps for the better you don't know that."
    hide BaPietro
    show Azu OngPietro at center
    P" Not sure how relevant, but you're probably right. Best not to intervene in the Church's doing. You and me, we're just plain ordinary folks..."
...
#Thời gian: Tối
    ...
    "Speaking of the man, he's waiting for me under a large tree. "
    "This time his attire consists of nothing but the color black: Black tunic, black pants and black cloak. Like one of those spies in a work of thriller fiction."
    ...
    Pa" Good morning indeed, Anatolio. Been good this morning, I hope?"
    A" … So-so, I suppose."
    show Azu Paul P0 at center
    Pa" Heh, Look at you. Unhappy with something?"
    A" I... am not sure, sir."
    show Azu Paul P0 at center
    Pa" Of course you are not. I would fancy a guess, though: You've heard of what happened to Hanes, haven't you?"

    "I bend my head."

    A"  Sir."

    " It's not too surprising that he knows, at this point. The question is more like, what am I to say to that? "
    "Or more pertinently: Why does he pay that much attention to Hanes' fate?"

    A" … I have to say yes."
    show Azu Paul P0 at center
    Pa" Now I'm not quite sure what to tell you myself. Condolences? Or congratulations?"
    ...
    Pa" So you're unhappy."
    A" Not. At. All. Sir,"

    " Again he nods once, and there's this look of mild approval on his face."

    show Azu Paul P1 at center
    Pa" Good, good. That's a good man."
    show Azu Paul P2 at center
    Pa" But if you asked me, I'd say this is very much an unfortunate turn of event.."
    A" “Unfortunate”?"
    A" Wait, aren't you people related to this in some way?"
    show Azu Paul P0 at center
    Pa" Well, well, well, Anatolio Pietro, hear me this, and keep it in mind: We are not murderers."
    show Azu Paul P2 at center
    Pa"  Plus, I... we have reasons to keep Hanes safe. We failed."
    A" No way... does that mean..."
    show Azu Paul P0 at center
    Pa" We have to suspect the Church did the deed. For reasons only they know."
    A" C-could it be that..."
    
    "A thought flash in my mind."
    
    A" I see. They want Aurora to catch Azzurra or at least make sure she doesn't attend the ceremony. "
    A" This is what Hanes has to do, and... and he failed. Is this his punishment?"
    show Azu Paul P0 at center
    Pa" Oh no. The Church isn't so low as to off someone for failing a task. I reckon there must be something else in this."
    show Azu Paul P2 at center
    Pa"  Perhaps he knows something he should not. Or he's been trying to use the Church to his own ends."
    show Azu Paul P0 at center
    Pa"  Or worse, betray the Church. "
    show Azu Paul P2 at center
    Pa"  If you catch my drift."
    ...
    Pa" In which case, I'd say, I agree with how they handled the matter."
    A" Hanes... you... are an idiot."
    
    show Azu Paul P0 at center

    Pa" You still can't think him an enemy."
    A" I can't sir. I'd be lying if I say I feel nothing after all this. I'm not a rock."
    A" He was our friend, and I wish he would continue to be. "
    A" Now he's no longer with us, there's no reason I should hate him.."
    show Azu Paul P0 at center
    Pa" If he were with us still, would you have forgiven him?"
    A" I would."
    ...
    A" This is..."
    show Azu Paul P0 at center
    Pa" A book. For you and Azzurra. I thought you'd like this."
    A" I... see."
    A" But what's the occasion?"
    show Azu Paul P0 at center
    Pa" A congratulatory gift, if you'd like. You've just had a narrow escape... which is as good a time for a celebration as any."
    ...
    show Azu Paul P2 at center
    Pa" You've got a welcoming package all right. "
    show Azu Paul P0 at center
    Pa" Its name is “Sun Festival”, and one way or another we've had our part to play in it."
    ...
    show Azu Paul P1 at center
    Pa" We're flattered, but ours is only a small part in all things."
    show Azu Paul P0 at center
    Pa" The rest is up to Father Fredo and his old friends. They'd probably think Azzurra is still a valuable card to play."
    show Azu Paul P2 at center
    Pa" They're not wrong per say."
    A" You don't seem to think very well of Father Fredo, do you?"
    show Azu Paul P0 at center
    Pa" Because an old snake is still a snake. "
    show Azu Paul P1 at center
    Pa" Massimiliano had better pray for death before we finish this war of ours."
    show Azu Paul P0 at center
    Pa" But that's all I'll say about that. "
    show Azu Paul P2 at center
    Pa" Don't want to take up the months upon months just recounting the ills the Templars' 'finest' used to do."
    show Azu Paul P0 at center
    Pa" Today I come here with a question... and several offers, depending on your answer to that one question."
    show Azu Paul P2 at center
    Pa" What do you want to do now?"
    A" What... I want to do?"
    show Azu Paul P0 at center
    Pa" That's what I mean. Your plans."
    ...
    show Azu Paul P0 at center
    Pa" Well, well, well, thought as much. Never thought of that, I believe?"
    A" That's... quite right, sir."

    " My voice drops to a whisper."

    show Azu Paul P3 at center
    Pa" Good news is, I've thought up some for you."
    show Azu Paul P1 at center
    Pa" Join us."
    ...
    A" Sort of, sir."
    show Azu Paul P1 at center
    Pa" Don't be. “Revolution” or as some would say “violent uprising” is currently far from our thought."
    show Azu Paul P0 at center
    Pa" What we need is more research. Basic, fundamental research."
    show Azu Paul P1 at center
    Pa" Got a team with us here, geniuses and brilliant minds, the lot of them. "
    show Azu Paul P0 at center
    Pa" Can't have better physicists alive – they'd have gone way further had they been born in brighter times."
    show Azu Paul P1 at center
    Pa" Einstein, Oppenheimer, Tesla. That's probably the sort of peer they'd have gotten were they to live in those times of booming innovation."
    show Azu Paul P0 at center
    Pa" See my two friends? That's the kind of people you can expect to see: scientists, not politicians. Bound to create issues if you misuse them."
    A" What will become of them, sir?"
    show Azu Paul P1 at center
    Pa" What do you think? We're not the Church. We try to maintain a lance between rationality and sentimentality."
    show Azu Paul P0 at center
    Pa"  Accordingly they'd be placed in a position that makes better use of their expertise."
    show Azu Paul P1 at center
    Pa" If you'd like, Hildegarde can be an amazing teacher for the like-minded. You'd learn plenty of great things. The offer goes to Azzurra too."
    A" But..."
    ...
    A" But then from the start I've been a normal fellow from a normal family. "
    A" What I have been doing all my life has been, well... eating, sleeping, playing, sketching things, and conducting silly experiments that were like child's play to you."
    A" You might think me brave, sir... but actually I'm not. Not at all."
    A" Joining you, well... I'm not sure if I have what it takes."
    A" After everything, I only want a peaceful life. A place to call home. Have everyone around me, my parents, Azzurra, and Elena as a friend of sort. "
    A" Serious science is not part of that life."
    ...
    show Azu Paul P0 at center
    Pa" No, no, that's basic human nature. You want peace. You want stability. You don't want uncertainty. I'm no stranger to that sentiment."
    Pa" But sometimes there is no peace in stability either."
    A" What do you mean?"
    show Azu Paul P1 at center
    Pa" I mean, my good lad, you and Azzurra do not have what you need in hand to fulfill your dream."
    A"Why would you think so?"
    show Azu Paul P0 at center
    Pa" Didn't you want to reach for the horizon?"
    show Azu Paul P2 at center
    Pa" How're you getting there? By broken-down bookshelves and aging book that may or may not be relevant?"

    " I bend my neck."
    "Mr. Attenborough's words are truer than I'd like. We don't have much between us: mostly my inheritance, which I'm not confident I'll do better with than my parents. "
    "Not enough to reach for the horizon by a long stretch."

    show Azu Paul P0 at center
    Pa" What would you say if I said Aurora can help you with that?."
    show Azu Paul P1 at center
    Pa" You saw our submarine. That was made a decade ago, and already an upgrade is in the work."
    show Azu Paul P0 at center
    Pa" We also discovered your effort to explore the nature of the rivers practically without trying."
    ...
    show Azu Paul P0 at center
    Pa" Let's just say materiel of all kinds, for transportation, science and war alike... "
    show Azu Paul P1 at center
    Pa" if you can draw up a blueprint, we can make them."
    show Azu Paul P2 at center
    Pa"  We're no longer living in those dark days where the Church are free to murder everyone and anyone they like and we can't do a thing about it."
    show Azu Paul P0 at center
    Pa" What we do lack is human capital. "
    show Azu Paul P2 at center
    Pa" That, too, will change in a generation or two. Curiosity is so central to the human psyche, that after a while there's not a thing you can do to bind it, not through religious dogma at any rate."
    show Azu Paul P0 at center
    Pa" If you should care to join? You'll be protected, and given all that you need to realize that dream you and Azzurra have been nurturing."
    A" But you said you tried to protect Hanes... and it didn't work out!"
    show Azu Paul P1 at center
    Pa" That's different. Hanes is not one of us. We can only do as much as we reasonably should."
    show Azu Paul P0 at center
    Pa" You and Azzurra? Much different."
    show Azu Paul P1 at center
    Pa" I strongly suspect there will be a time we will have to count on you. You'll have access to privileges even I don't have."
    A" I... see."
    A" Could I take some time to think about it?"
    show Azu Paul P0 at center
    Pa" All the time in the world, lad. All the time in the world."
    A" May I ask you something... irrelevant, sir?"
    Pa" Nothing is too irrelevant in the eyes of a trained mind. Shoot."
    ...
    show Azu Paul P0 at center
    Pa" Well, to that I'll give you one word. Just one: “Agnostikos”."
    A"  “Agnostikos”?"
    show Azu Paul P1 at center
    Pa" “Unknowable”. A dead word, in a dead language from a dead civilization. Something deemed impossible to truly discover or figure out."
    A" But that conflicts with what Aurora is, doesn't it? Don't you exist to learn all that there is to learn?"
    show Azu Paul P2 at center
    Pa" I've already said this once, I think. We're scientist. "
    show Azu Paul P0 at center
    Pa" The first commandment in our figurative scripture is the admission that there are limits to what we shall know."
    show Azu Paul P2 at center
    Pa" Take the Creator, Meyr as his tabooed name is. "
    show Azu Paul P0 at center
    Pa" There's a possibility that something out there in this universe exists just as the Church describes it, and we cannot discount that very real possibility. "
    show Azu Paul P2 at center
    Pa" The only problem is you cannot use the scientific method – yet, hopefully – to truly find out whether the truth is one way or the other."
    show Azu Paul P0 at center
    Pa" We put such matters into the “unknowable” basket. Impossible to prove or disprove. Maybe it's better that way."
    A" So why fight the Church?"
    show Azu Paul P2 at center
    Pa" Because that which they claim to be the truth is plain wrong. We could even live with such falsehood, if they hadn't been profiting from it."
    show Azu Paul P0 at center
    Pa" Ah, I'm probably not the best to ask, out there. If you care to join? You'll be schooled in these matters and probably a lot more by the masters until all your questions have been well answered."
    A" Aren't you a master yourself, sir?"
    show Azu Paul P1 at center
    Pa" Me? Hah, I wish. Compare to the prodigies I mentioned? I'm just a third-rate scholar, "
    show Azu Paul P0 at center
    Pa" who happens to do politics and maneuvering a bit better than he does research. Fortunately there's some use for that skill somewhere..."
    ...
    show Azu Paul P0 at center
    Pa" Say, I'll give you... five days. I'll be waiting here for you, at this exact spot, after the moon rises. "
    Pa"If you still aren't here by midnight, I'll take it that you have refused, and won't bother your new life any further. Deal?"

    " I nod, and look him in the eyes."

    A" Deal."
    show Azu Paul P1 at center
    Pa" Then it's decided. Hopefully you'll make the best choice in five days' time."

#Cảnh: Đen
    scene black with fade
    nvlDC"Time slows to a crawl as the weekend approaches."
...
#(Tiếng gõ cửa)
    ...
    stop sound
    " Well, dear me. Even my jovial door calling has lost all of its mischief that I would normally be so proud of. "
    "That mischievous Anatolio might have as well died an ignoble death and buried six feet under..."
...
#Thời gian: Sáng
    ...
    Az" And everything else, too. We all know the upper-class people had something to do with it, and I have something to do with it. "
    show Azu P39 at center
    Az" And that just makes everything that much more suspicious. Wouldn't you have asked?"
    ...
    Az" The thing with my aunt and uncle being impostors How'd you know?"
    show Azu P52 at center
    Az"  Coincidence? Or a little bird told you?"
