    ...
    frame:
        ...
        vbox:
            if persistent.Sys_Langue == "ENG":
                ...
                textbutton "Yes" action yes_action hover_sound "sfx/click.ogg" xalign 0.5 style "Style_MainMenu"  at Sys_Eff_Appear
                textbutton "No" action no_action hover_sound "sfx/click.ogg" xalign 0.5 style "Style_MainMenu"  at Sys_Eff_Appear
                ...
                textbutton "Có" action yes_action hover_sound "sfx/click.ogg" xalign 0.5 style "Style_MainMenu"  at Sys_Eff_Appear
                textbutton "Không" action no_action hover_sound "sfx/click.ogg" xalign 0.5  style "Style_MainMenu"  at Sys_Eff_Appear
