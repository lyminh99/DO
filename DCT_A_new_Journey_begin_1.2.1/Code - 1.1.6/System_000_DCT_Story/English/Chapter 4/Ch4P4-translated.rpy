...
#Azzurra (nhìn chăm chăm): 
    ...
    Az" I am just thinking, were it not me but some other noble lady's home that you barged into without permission "

    show Azu P38 at center
    Az" Well, that might have been the end of Anatolio Pietro..."
    A" L-let's hope not!"
...
#Thời gian: tối
    ...
    show Azu P39 at center
    Az" They kept me gagged. For a time I fell asleep. "
    Az"When I woke up, I was still in the carriage, while the two drivers sit at the front. I don't see their faces, only hear their voices."
    show Azu P42 at center
    ...
    Az" I... I thought it would have been better if I were still in a coma. Then I wouldn't have to hear anything, or know anything any more."
    Az" Let the Creator and His hand arrange my destiny – like a sinner awaiting her final judgement. Business as usual, that's what I thought."
    A" Azzurra…"
    show Azu P43 at center
    Az" But then, I thought of you guys. You've opened my eyes. I'm not a sinner. I've been judged, and proven innocent. "
    Az" There is no reason I have to shut up and take punishment for sins I have not committed!"
    show Azu P42 at center
    ...
    Az" I wanted to escape. I wanted to be free. So I thought I should save myself. I'm pretty sure the door's locked, and there's no way I can break out of it."
    Az"And even if I can, it isn't like I can just jump off a moving carriage unhurt. "
    Az"And even if I can do that, well, trying to run away from a horse-drawn carriage is going to be rather pointless, don't you think?"
    ...
    Az" Like a charm! Picture this: All of this happens on a busy street aaaaand raised quite a pretty ruckus. "
    Az" All you need for the people around to look at you is to behave just a little oddly."
    show Azu P54 at center
    Az" One scream and a lot of noisy neighs later, we've got a rather sizable horse of bystanders gathering the carriage. "
    show Azu P53 at center
    Az" Some were curious, and the others thought that, well, my abductors were behaving rather oddly."

    show Azu P41 at center
    Az" While these pleasant folks were caught up with their business, all I needed to do was to sneak of the carriage. "
    Az"Turns out they didn't lock thwe door as securely as they could have, and there I was!"
    show Azu P42 at center
    Az" I thought I should go home right then and there, but then I was afraid maybe these people would be waiting for me there."
    Az" They might know where I live, and that frightened me more than anything."

    show Azu P42 at center
    Az" I could only think to go the the safest place I know: the chapel. There I met Hanes... and he took me home."
    show Azu P53 at center
    Az"  Thankfully, then the rain starts. And it looks like they don't know where I live after all. So I guess I've earned myself a breather."
    show Azu P54 at center
...
#//delay 1s// 
    ...
    Az"  My very best friend! Now I am not afraid of anything any more. Especially since—"
