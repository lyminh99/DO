label Escape_E002_E001_C002_E001_E001_E001_E:
    $ Sys_GameProgress = "Escape_E002_E001_C002_E001_E001_E001"
    if Sys_SkipAll > 0:
            ...
            " Suddenly Azzurra about-faces. She walks, and then runs, towards the door."
            "Next thing I heard, the door slams closed with a deafening thud. Panic overtakes me."
        ...
        #Thời gian: tối (mưa)
            ...
            " Wait, am I hearing myself right? Or did the rainwater clog my ears just now, or was it the thunder? "
            "Didn't she say she's not running away?"

            A" Then why did you run then? You're looking for a place to cry alone, right? "
            A"No, that's fine, you can come to me. Cry on my shoulder if you want. No need to stand in the rain alone, you know?"
        ...
        #Thời gian: tối (mưa)
            ...
            "Suddenly all else melts away, the night and the leaves and the rain. "
            "There is only a great old tree, majestic yet alone like a crownless king, shunned by his own subjects."
            ...
            "Not because I'd rather not lie as a matter of principles, nor even by the perceived troubles I would have if I admit to have been here with Elena."
            ...
            Az" That's shortly after Gramps passed away. "
            show Azu P54 at center
            Az" I was rather... depressed, then. Thinking of it now... I must have worried everyone. And you too, of course."
            show Azu P53 at center
            ...
            show Azu P54 at center
            Az" To think of it, my mind was full of the color black back then. "
            show Azu P52 at center
            Az" Not the night sky black, but that all-swallowing pitch black that swallows all light no matter what or where."
            show Azu P50 at center
        ...
        #Thời gian: tối (mưa)
            ...
            Az" You gave me a picture that Gramps himself drew, of this tree. Then you issued me a challenge. "
            show Azu P41 at center
            Az" What was it, Anatolio? You do recall, do you?"
            A" ……………"
        ...
        #Thời gian: tối (mưa)
            ...
            show Azu P52 at center
            Az" I couldn't tell one end of the brush from the other."
            show Azu P53 at center
            Az"  So I begged you to do it. You must have felt like a hero then, breaking me from my trance and all."
            show Azu P54 at center
            Az" So you suggested we have a small competition or two. "
            show Azu P52 at center
            Az" Even saying Gramps won't come back until I can match you with the brush."
            show Azu P50 at center
        ...
        #Thời gian: quá khứ
            ...
            "Right. The picture."
            "We were much drawing the same thing, yet my tree and Azzurra's tree were worlds apart. "
            "Not entirely like falling from the fabled Asgard to Niflheim, but there's something about how she shaped every cloud, "
            "every branch and every leaf that simply makes people... think."
            "Now that I think about it, I can't really judge her drawing as is. In a sense, that art of hers fitted her style: innocent and childlike. "
            "After all, you can't expect a wild man to dress smart, or Cinderella to wear a mermaid tail."
        ...
        #Thời gian: tối-mưa
            ...
            show Azu P40 at center
            Az" I still remember how disappointed I was – disappointed and distraught, and maybe a bit jealous."
            show Azu P52 at center
            Az"  I told myself then, that Fate itself had had it that I can't see Gramps again."

            show Azu P38 at center
            Az" Peace through acceptance, that's how it was. "
            show Azu P52 at center
            Az" The more I learned to accept, the less painful everything felt."
            show Azu P53 at center
            Az"  I see no more blackness, I instead see this old tree."
            show Azu P38 at center
        ...
        #Thời gian: quá khứ
            scene BG_4b with fade
            " An artist, huh."
            "Under the overarching look of a philosopher and a rationalist, there actually isn't all that much different between an artist and a scientist. "
            "They both explore the physical world around them through differing approaches."
        ...
        #Azzurra (cười tít mắt): 
            show Azu P40 at center
            Az" Sharp as always, Anatolio. How'd you guessed?"
            ...
            Az" Thought it was lucky the bridge got shut down as it was. "
            show Azu P48 at center
            Az" Glad that the City's finally divided for good by divine ordinance. And rather enraged that the bridge is finally opened again."
            show Azu P42 at center
        ...
        #Azzurra (quay lưng): 
            ...
            Az" Well, that is. That was when I realized..."

            Az" Such injustice isn't solely on my shoulder."

            Az" But on everyone of us.."

            Az" As are the wont of the shadow... those close to it loses their humanity, right? "

            Az" If I... If I am to remain close to you, or those around you, Ana, you'll be just like me. An abomination. Aberration. Hated and disdained."

            Az" Perhaps there is a place for me, under this sky... but it may not be here, and definitely not with you."
            ...
            show Azu P41 at center
            Az" I've thought of running away every time something happens. "
            show Azu P38 at center
            Az" Perhaps I've become reliant on the pity of others, since Father Fredo and Gramps saved me."
            A" Azzurra, I will be on your side! No matter what!"
            show Azu P39 at center
            Az" I know, Anatolio. Just too well. So often you've been waking me up, one way or another. "
            show Azu P40 at center
            Az"From a fool who learns nothing, to who I am today... Anatolio, I've always have you to thank."
            show Azu P41 at center
            Az"In my life now, there is your parents, there is Mr. Ascenderos, warts and all, and everyone too. "
            show Azu P50 at center
            Az"Then there is you, and if everyone else is to vanish you'll be there, and all will be well."
            show Azu P33_1 at center
            Az" You will keep the darkness away."
            ...
            show Azu P38 at center
            Az" I've decided I won't run away any more. I'll accept everything life throws at me."
            show Azu P39 at center
            Az"  I'll remain here, walk this unfriendly earth; not for its sake, nor because I'd rather like its twists and turns."
            show Azu P40 at center
        ...
        #Cảnh: đen
            ...
            "Over the last twenty-four hours I've come to accept the fact that my dear former student has learnt something I am barely an apprentice in: hiding her emotions. "
            "That means... no, I have to dig deeper. Is there anything that doesn't add up? What, and where?"
        ...
        #Azzurra (trố mắt): 
            ...
            A" Humans are born into an endless struggle. Nothing comes easy, think about it! It's not just your life, but mine, too! I exist because of Mom's struggle. "
            A" Our everyday life? Food on the table, roof over our head? Same!"
            A" Aurora, too, have their own fight – for what they believe right!"
            A" You are born human, Azzurra. Whatever they do, whether they hate you, shun you, deceive you, you are still as human as any of us, flesh and blood and soul and mind. "
            A" Why take unfairness without a fight? That's just not right! ."
            ...
            A" You weren't quick or witty as a child. It was hard to teach you anything. At times I thought, was it worth it to keep teaching a girl who clearly wasn't learning anything? "
            A" Or would it be better to do what I was told to the letter – to protect you like a feeble girl who needs protection?"
            ...
            show Azu P54 at center
            Az" Do you know how hard it is, continue living in such shadow everyday? "
            show Azu P52 at center
            Az" Wishing for no more than another day to pass?"
            show Azu P53 at center
        ...
        #Thời gian: tối. mưa
            ...
            show Azu P50 at center
            Az" What…?"
            A" Think back that moment you stormed out. Or when you were sobbing – wanting to say something but couldn't – and didn't."
            A" Someone who accepts a burden as a matter of course... will not do that."
            A" You're hiding, Azzurra. I... understood as much, whether you do the same or not."
            A" But... please do, Azzurra. What you need to accept is not lies and abuses and excuses. "
            A" But your emotions – the real Azzurra hiding behind the shadow weaved by those who hate her."
            A" WAKE UP! AZZURRA!"
        ...
        #//NVL
            nvl_Center"The passion of courage."
            nvl_Center"The taste of the glowing dawn."
            nvl_Center"Were this moment to last for an eternity..."
            nvl_Center"Or conversely, were it to end in a heartbeat…"
            nvl_Center"No, either way, there shall be no regret."
            nvl_Center"We have each other…"
            nvl_Center"If every single dawn,"
            nvl_Center"today,"
            nvl_Center"tomorrow,"
            nvl_Center"or so many decades to come,"
            nvl_Center"were to be of ruin and damnation,"
            nvl_Center"my fingers and Azzurra's,"
            nvl_Center"Ours shall turn them into עדן light unending."
            nvl clear
