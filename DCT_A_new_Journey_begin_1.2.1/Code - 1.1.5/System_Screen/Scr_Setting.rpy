...
screen Scr_Setting:
    ...
    frame:
        ...
        hbox:
            ...
            vbox:
                if Sys_Langue == "ENG":
                    textbutton "VN" action SetVariable ("Sys_Langue", "VN") hovered [ Play ("test_one", "sfx/click.ogg")] style "Style_Setting"
                    hbox:
                    ...
                    textbutton "ENG" action SetVariable ("Sys_Langue", "ENG") hovered [ Play ("test_one", "sfx/click.ogg")] style "Style_Setting"
                    hbox:
