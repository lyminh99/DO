...
#thời gian: chiều 
    ...
    "I prop my chin, making the most serious face within my capability."
    "The most difficult thing of being boss is not sitting on that chair, but carry yourself in such a way that the others respect your authority."
    " That's what I've been trying to live up to."
    ...
    "Lest you forget, this is a difficult problem Mr. Ines posed back in his days. "
    "It ranks first among all his unanswered questions at the back of his journal."
...
#Thời gian: chiều
    ...
    "Hanes rubs the leaves in his hand, as though grooming a pet puppy. "
    "Perhaps this truly is what he's good at, given all that he's been talking about over the last few minutes."
    " I don't know, I'm getting excited. As if the results we're after is right there, in front of us."
...
#Thời gian: chiều
    ...
    "Not usual dirt balls, mind you: They contain Eichhornia shoots within them. As the book noted, this plant reproduces asexually."
    " Which is to say, new plant stems will be born from the leaves themselves. This is extremely conducive to what we're doing. No more worrying about seeds and all that."
    "One problem remains: this plant floats on the surface. "
    "That is where the dirt balls came in: wrapping the leaves within such balls, I can be sure they will sink to the bottom."
    " Then after a while, the dirt will be washed away, and up the plant will float."
    ...
    "Azzurra looks up into the sky. There the bits and pieces of fluffy clouds are gathering, as if heralding the coming of winter. "
    "The Church has yet to make a statement, though – looks like this winter will be warm and generic."
...
#Azzurra //đứng từ xa//: 
    ...
    Az"  Anatolio? What are you doing? Let's go!"

#Hanes //đứng từ xa//: 
    hide Azu P3
    show Azu Hanes P0 at center
    H" If you d-don't, the fa-fame's all mine!"
    A" Right, right. Here I come. A moment puh-lease!"

#Hanes//không sprite//: 

    show Azu Hanes P1 at center
    H" Haha! D-dreaming something, Anatolio?"
    A" What dream?"
...
#Thời gian: sáng
    ...
    "That, too, turned out to be impossible. The Astraea alone is much longer than we thought."
    " It crosses a thick forest, too, a sight that downright frightened Azzurra. That was why we decided to abandon that plan, instead merely waited downstreams.  "
...
#Thời gian: sáng
    ...
    "I quickly shoot a glance at the white-haired pal sitting at the opposite corner. "
    "He's seemingly absorbed in a certain something on the shelf. No wonder he jumps when I calls him."
    hide Azu P37
    show Azu Hanes P0 at center
...
#Thời gian: sáng
    ...
    "Hanes' voice echoes all over the holy ground of the cathedral. Father Fredo, as per usual, is off somewhere on Church duty."
    " I wouldn't wish that weight upon anyone: he was leading a ceremony at the cathedral just earlier, and already he's off."


    A" Challenge, with these questions?"
    show Azu Hanes P0 at center
    H" Y-yep. The rule was, each would br-bring forward a question. The rest w-would come up with an an-answer."
    H" One answer p-per person. W-whoever gets the right answer gets one t-third of the poker winnings. If not, the as-asker gets the share."
    A" That is too simple isn't it? They have three different professions... different expertise."
    A" Ask something within their respective specialty, and the remaining two will be stumped."
    ...
    show Azu Hanes P0 at center
    H" The rule w-was, the question has to be based on things all th-three players have already known. "
    H" In o-other words, they all have the key within them. Except they d-don't know where it m-might be."
    "A musician. A teacher. An engineer. Well, color me surprised."
    " I might buy it that a teacher and an engineer might have met before. But an artist? Where's the logical connection?"
...
#Thời gian: sáng
    ...
    show Azu Hanes P1 at center
    H" First c-came the engineer's q-question: On the wall of the t-tavern a wh-wheel was hung. "
    H" Assuming it had been sus-suspended on a rope: one connected to the ce-ceiling, the other to the cen-center of its mass without any support."
    H" H-how do you keep the w-wheel vertical?"
...
#//Hanes cười nham hiểm//
    ...
    "I toss him a toy wheel and a fishing string."
    " That's me and my lack of neatness: I can produce junks like this without even knowing where I got them from, just lying around there."
