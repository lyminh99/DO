...
#//hết ỉu xìu// 
    ...
    show Azu OngPietro at center
    P"Well, darn. Very well, trivia time! Got a small question for the lot of you!"
...
#Azzurra (trố mắt): 
    ...
    Az" Me too! It's amazing! Like... I can't ever get tired of it!"    show Azu P41 at center
    ...
    "It's not that odd to encounter a funeral procession on the way to, you know, a cemetery."
    "For want of any real knowledge of flowers and their language, I'm sure that's the most rational, educated guess I can make."
    ...
    "Meanwhile, Azzurra is just about giggling – at my expense. "
    "But not for long: her curiosity soon takes over, and she turns around to a Hanes, whose face betrays both some pride and a lot of bashfulness."
    ...
    hide Azu P40    
    show Azu Hanes P0 at center
    H" Ah! C-coincid-dental, that w-was. Just a m-month ago we've got this m-meeting at the Chapel. "
    show Azu Hanes P1 at center
    H" They gave him a small bouq- I mean, a small ball of flowers, just-just like these!"

#Azzurra (nghiêng đầu): 

    show Azu P50 at center
    Az" Why call it a ball of flower?"
    hide Azu P50
    show Azu Hanes P0 at center
    ...
    show Azu OngPietro at center
    P" Well, you're right, lad. It's called Alyssa. Tiny, it is, and rather white. Or purple, if nature feels like it."
    show Azu OngPietro at center
    P" They grow into the likeness of a sphere, see? That's why some refers to it as a flower ball."
    "Dad interrupts Hanes before he can continue."
    show Azu OngPietro at center
    P" Grows only in spring, too, so we don't smell them often when we visit the cemetary. "
    show Azu OngPietro at center
    P" Though since last year, the local managed to somehow grow it all year long. So here we have it!"

    "He rapid-fires his speech, as if fearing a kid a third his age would usurp his position of authority "
    "Or perhaps, just like me, he's afraid Hanes would ask him questions he can't answer.."
    ...
    show Azu Hanes P0 at center
    H" Anatolio. Azzurra. Y-you see. F-Father Fredo himself has n-never quite been to t-these places. "
    show Azu Hanes P2 at center
    H" Y-yet they're always in his t-thoughts. I-I wonder if he h-has p-plans of his own, sending us to do this, d-don't you think?"
    show Azu Hanes P0 at center
    ...
    "I am, miraculously, able to shut down Azzurra's storm of emotions before any permanent harm is done. "
    "Don't get me wrong: I'm rather in agreement with Azzurra, but exposing our little secrets before the proud-and-pious Mr. Pietro? Bad idea, pal. Really bad idea."
