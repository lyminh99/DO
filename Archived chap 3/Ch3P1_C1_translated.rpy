...
#Azzurra (ngó lơ): 
    ...
    A" Azzurra."
    A" I..."
    A" well, I know it's not easy for you to come here, but that doesn't..."
    A" well, that shouldn't mean carrying that gloomy face all the way, should it? That isn't good for you, y'know?"
...
#Azzurra (nhìn về phía Ana): 
    ...
    show Azu OngPietro at center
    P" It's so tiny, and grows in clusters, you see." 

    show Azu OngPietro at center
    P" Spring's when it blooms, and is quite a familiar thing to those who'd visit graves at the time. But then somehow for a few years now someone managed to make them bloom all years long."
    show Azu OngPietro at center
    ...
    Az" I say they deserve sympathy for the wonders they've been able to make, not scorn! Isn't it too extreme to burn books and deny all that they've discovered? 
    show Azu P42 at center
    Az" Like what we-"
    A" Shush!"
